<template>
    <div>
        ...
        <div class="text-center my-4 dark:text-white flex items-center justify-center">
            Instagram <a href="https://www.instagram.com/aditya_andika_s/" target="_blank"
                class="text-white py-1 px-2 ms-2 rounded-md bg-blue-600">@aditya_andika_s</a>
        </div>
        <div class="text-center">
            ...
            <a href="mailto:adityaandikasetiawan@gmail.com"
                class="m-1 p-1 text-gray-600 text-2xl hover:text-blue-600 dark:text-gray-400"> <font-awesome-icon
